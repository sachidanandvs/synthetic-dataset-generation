...
from src.image_augmentation.object_position import find_valid_object_position, find_valid_distractor_position
...
def create_image_anno(
    ...
    while True:  # creating new attempts for synthesizing
        ...
        for idx, img_data in enumerate(all_objects):
            ...
            if(img_data.label_id == -1):
                print("True")
                x, y, attempt = find_valid_distractor_position(
